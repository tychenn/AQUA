...
def rank(watermarkedmmrag):
    ...
    if watermarkedmmrag.args.watermark_type=='acronym_rescale':
        directory_path="datasets/special_query_attack/acronym_rescale_1_5"
    elif watermarkedmmrag.args.watermark_type=='acronym_rotate':
        directory_path="datasets/special_query_attack/acronym_rotate_45"
    elif watermarkedmmrag.args.watermark_type=='acronym_gaussian':
        directory_path="datasets/special_query_attack/acronym_gaussian"
    elif watermarkedmmrag.args.watermark_type=='acronym_all':
        directory_path="datasets/special_query_attack/acronym_all"
    elif watermarkedmmrag.args.watermark_type=='spatial_rescale':
        directory_path="datasets/special_query_attack/spatial_rescale"
    elif watermarkedmmrag.args.watermark_type=='spatial_rotate':
        directory_path="datasets/special_query_attack/spatial_rotate"
    elif watermarkedmmrag.args.watermark_type=='spatial_gaussian':
        directory_path="datasets/special_query_attack/spatial_gaussian"
    elif watermarkedmmrag.args.watermark_type=='spatial_all':
        directory_path="datasets/special_query_attack/spatial_all"
    elif watermarkedmmrag.args.watermark_type=='opt_rescale':
        directory_path="datasets/special_query_attack/opt_rescale"
    elif watermarkedmmrag.args.watermark_type=='opt_rotate':
        directory_path="datasets/special_query_attack/opt_rotate"
    elif watermarkedmmrag.args.watermark_type=='opt_gaussian':
        directory_path="datasets/special_query_attack/opt_gaussian"
    elif watermarkedmmrag.args.watermark_type=='opt_all':
        directory_path="datasets/special_query_attack/opt_all"
...
def CGSR(watermarkedmmrag):
    if watermarkedmmrag.args.watermark_type=='acronym_rescale':
        directory_path="datasets/special_query_attack/acronym_rescale_1_5"
        image_path_dir="datasets/watermark_images_attackd/acronym_rescale_1_5"
    elif watermarkedmmrag.args.watermark_type=='acronym_rotate':
        directory_path="datasets/special_query_attack/acronym_rotate_45"
        image_path_dir="datasets/watermark_images_attackd/acronym_rotate_45"
    elif watermarkedmmrag.args.watermark_type=='acronym_gaussian':
        directory_path="datasets/special_query_attack/acronym_gaussian"
        image_path_dir="datasets/watermark_images_attackd/acronym_gaussian"
    elif watermarkedmmrag.args.watermark_type=='acronym_all':
        directory_path="datasets/special_query_attack/acronym_all"
        image_path_dir="datasets/watermark_images_attackd/acronym_all"
    retrieved_num=0
...
if __name__ == "__main__":
    ...
    parser.add_argument("--json_dir", type=str, default=f"datasets/special_query_attack/{exp_name}", help="")
