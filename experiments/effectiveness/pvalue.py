...
def calculate_pvalue(MultimodalRAG,query_times=500):
    #save_dir
    ...
    if MultimodalRAG.args.watermark_type=='acronym':
        ...
        if MultimodalRAG.args.generator_type in ["LLaVA", "TinyLLaVA-3.1B"]:
        ...
        elif MultimodalRAG.args.generator_type in ["Qwen2.5-VL-7B-Instruct","Qwen3-VL-32B-Instruct"]:
...
if __name__ == "__main__":
    ...
    rank=calculate_pvalue(watermarkedmmrag)#generator_type=="None"
    print("rank=", rank)
